...
def cria_cliente(request):
    ...
    c_view = "cria_cliente"
    idcliente = None
    data = facade.form_cliente(
        request, c_form, c_idobj, c_url, c_view, idcliente
    )
    return data
...
def exclui_cliente(request, idcliente):
    ...
    idcliente = idcliente
    data = facade.form_exclui_cliente(
        request, c_idobj, c_url, c_view, idcliente
    )
    return data
...
def criaformapgto(request):
    ...
    return render(
        request, "clientes/criaformapgto.html", {"formapgto": formapgto}
    )
