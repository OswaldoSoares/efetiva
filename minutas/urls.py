...
from .views import index_minuta, criaminuta, editaminuta, imprimeminuta, conclui_minuta, fecha_minuta, estorna_minuta,\
    ...
    edita_minuta_veiculo_solicitado, insere_ajudante, remove_ajudante, edita_minuta_hora_final, \
    edita_minuta_km_inicial, edita_minuta_km_final
...
urlpatterns = [
    ...
    path('removeajudante/', remove_ajudante, name='removeajudante'),
]